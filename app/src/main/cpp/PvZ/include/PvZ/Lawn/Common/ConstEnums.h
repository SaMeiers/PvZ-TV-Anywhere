...
enum ParticleEffect {
    ...
    PARTICLE_CREDITS_STROBE,
    PARTICLE_CREDITS_RAYS_WIPE,
    PARTICLE_CREDITS_ZOMBIE_HEAD_WIPE,
    PARTICLE_STARBURST = 104,
    PARTICLE_CREDITS_FOG,
    PARTICLE_UPSELL_ARROW,
    PARTICLE_TROPHY_DROP_DUST,
...
enum ProjectileType {
    ...
    PROJECTILE_TELEPORTATION,
    PROJECTILE_TRAFFIC_CONE,
    PROJECTILE_ACKEE,
...
enum ReanimationType {
    ...
    REANIM_GIGA_IMP,
    REANIM_LIGHTNING_HIT,
    REANIM_DOGWALKER,
    REANIM_DOG,
    REANIM_ZOMBIE_TELEPORTATION,
    REANIM_TELEPORTATION,
    REANIM_TELEPORTATION_BULLET_FLASH,
    REANIM_SUPER_NOVA_GARGANTUAR,
    REANIM_SUPER_NOVA,
    REANIM_ZOMBIE_CROSSING_GUARD,
    REANIM_ZOMBIE_SCIENTIST,
    REANIM_HEAL_PARTICLES,
    REANIM_HEAL_MIST,
...
enum ZombiePhase {
    ...
    PHASE_DOGWALKER_ROPE_BREAK,
    PHASE_DOG_WALKING,
    PHASE_DOG_RUNNING,
    PHASE_TELEPORTATION_PRE_SHOOT,
    PHASE_TELEPORTATION_SHOOTING,
    PHASE_SUPER_NOVA_GARGANTUAR_DESTROY,
    PHASE_CROSSING_GUARD_THROWING,
    PHASE_SCIENTIST_WAITING,
    PHASE_SCIENTIST_SHOOTING,
    // extended end
};
enum ZombieType {
    ZOMBIE_INVALID = -1,
    ...
    ZOMBIE_DOGWALKER,
    ZOMBIE_DOG,
    ZOMBIE_TELEPORTATION,
    ZOMBIE_SUPER_NOVA_GARGANTUAR,
    ZOMBIE_CROSSING_GUARD,
    ZOMBIE_SCIENTIST,
